...
//         <Box className='even-odd-bg w-full rounded-b-[10%] border-[10px] border-t-0 border-[#17a2b8] pb-10' style={{}}>
//           {/* Header */}
...
//                     {/* slider */}
//                     <Flex className='relative w-full justify-betwwen gap-4 text-white text-sm mt-2'>
...
//               {(isEven && userChoice === "even") ? (
//                 <Box>
//                   <Box>
//                     EVEN
//                   </Box>
//                   <Text>{`You won! 🎉 Your winnings: ${betAmount * 2}`}</Text>
//                 </Box>
//               ) : (
//                 <Box>
//                   <Box>
//                     Even
//                   </Box>
//                   <Text>Sorry! You chose ODD</Text>
//                 </Box>
//               )}

//               {(!isEven && userChoice === "odd") ? (
//                 <Box>
//                   <Box>
//                     ODD
//                   </Box>
...
//                     ODD
//                   </Box>
//                   <Text>Sorry! You chose Even</Text>
//                 </Box>
//               )}
...
//           <Box className="bg-[#0a9737] shadow-[0_3px_6px_rgba(0, 0, 0, 0.16), _0_3px_6px_rgba(0, 0, 0, 0.23)] px-3 py-2 w-[50%] font-semibold text-[1.5rem] flex flex-col items-center" onClick={() => handleUserChoice("even")}>
//             <span>EVEN</span>
//             <span className='text-[.9rem]'>Pays 2x</span>
//           </Box>
//           <Box className="bg-[#de9244] shadow-[0_3px_6px_rgba(0, 0, 0, 0.16), _0_3px_6px_rgba(0, 0, 0, 0.23)] px-3 py-2 w-[50%] font-semibold text-[1.5rem] flex flex-col items-center " onClick={() => handleUserChoice("odd")}>
//             <span>ODD</span>
//             <span className='text-[.9rem]'>Pays 2x</span>
//           </Box>
//         </Flex>
